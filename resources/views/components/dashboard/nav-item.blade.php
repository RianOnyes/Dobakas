...
@php
    ...
    $classes = $isActive 
        ? 'bg-berkah-hijau-gelap text-white' 
        : 'text-berkah-mint hover:text-white hover:bg-berkah-hijau-gelap';
@endphp

<li>
    <a href="{{ $route !== '#' ? route($route) : '#' }}" 
       class="group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold transition-colors {{ $classes }}">
