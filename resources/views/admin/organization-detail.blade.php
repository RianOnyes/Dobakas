            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-6">
                            ...
                            <div class="flex items-start space-x-6">
                                ...
                                <div class="flex-1">
                                    <div class="flex items-center justify-between">
                                        <h3 class="text-2xl font-bold text-gray-900 ">{{ $organization->organization_name }}</h3>
                    ...
                    @if($organization->needs_list && count($organization->needs_list) > 0)
                        <div class="bg-slate-100 overflow-hidden shadow-sm sm:rounded-lg">
                            <div class="p-6">
                                <h3 class="text-lg font-medium text-gray-900 mb-4">Kebutuhan Organisasi</h3>
                    ...
                    <div class="bg-slate-100 overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            <h3 class="text-lg font-medium text-gray-900 mb-4">Donasi yang Diterima</h3>
                                    ...
                                    @foreach($claimedDonations as $donation)
                                        <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                            <div class="flex items-center space-x-4">
                                                ...
                                                @endif
                                                <div>
                                                    <h4 class="text-sm font-medium text-gray-900 ">{{ $donation->title }}</h4>
                    ...
                    <div class="bg-slate-100 overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            ...
                            <div class="space-y-3">
                                ...
                                <div>
                                    <span class="text-sm font-medium text-gray-900 ">Nama Pengguna:</span>
                                ...
                                <div>
                                    <span class="text-sm font-medium text-gray-900 ">Terakhir Aktif:</span>
                        ...
                        <div class="p-6">
                            ...
                            <div class="space-y-4">
                                <div class="flex justify-between">
                                    ...
                                    <span class="text-sm font-medium text-gray-900 ">{{ $claimedDonations->count() }}</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-sm text-gray-500 dark:text-gray-400">Donasi Selesai:</span>
                                    <span class="text-sm font-medium text-gray-900 ">{{ $claimedDonations->where('status', 'completed')->count() }}</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-sm text-gray-500 dark:text-gray-400">Dalam Proses:</span>
                                    <span class="text-sm font-medium text-gray-900 ">{{ $claimedDonations->where('status', 'claimed')->count() }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
