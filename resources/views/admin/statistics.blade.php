    ...
    <div class="py-4 sm:py-6 lg:py-12">
        <div class="max-w-7xl mx-auto space-y-4 sm:space-y-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                ...
                <!-- <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-4 sm:p-6">
                        <h3 class="text-base sm:text-lg font-medium text-gray-900 dark:text-gray-100 mb-4">Total Permintaan Donasi</h3>
                ...
                <!-- <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-4 sm:p-6">
                        <h3 class="text-base sm:text-lg font-medium text-gray-900 dark:text-gray-100 mb-4">Persebaran Pengguna</h3>
                        <div class="h-64 sm:h-80 relative">
                        ...
                        <div class="block lg:hidden space-y-3">
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-3">
                                <div class="flex items-center justify-between mb-2">
                                    ...
                                    <span class="text-sm font-semibold text-purple-600">{{ $org->donations_count ?? 0 }} klaim</span>
                                </div>
                            ...
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100">{{ $org->donations_count ?? 0 }}</td>
                                    </tr>
                                    @empty
                                    <tr>
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-3">
                            <div class="flex items-start justify-between">
                                <div class="flex-1 min-w-0">
                                    <h4 class="text-sm font-medium text-gray-900 dark:text-gray-100 truncate">{{ $activity['message'] ?? 'Unknown Activity' }}</h4>
                                    <p class="text-xs text-gray-500 dark:text-gray-300 mt-1">{{ $activity['user_name'] ?? 'Unknown' }}</p>
                                    <p class="text-xs text-gray-400 dark:text-gray-500 mt-1">{{ isset($activity['created_at']) ? $activity['created_at']->format('d/m/Y H:i') : '-' }}</p>
                                </div>
                                <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-gray-100 text-gray-800 dark:bg-gray-900 dark:text-gray-200 ml-2 flex-shrink-0">
                    ...
                    <div class="hidden lg:block overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                @forelse($recentActivities as $activity)
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-gray-100">{{ Str::limit($activity['message'] ?? 'Unknown Activity', 40) }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-300">{{ $activity['user_name'] ?? 'Unknown' }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800 dark:bg-gray-900 dark:text-gray-200">
                                            {{ ucfirst($activity['status'] ?? 'unknown') }}
                                        </span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-300">{{ isset($activity['created_at']) ? $activity['created_at']->format('d/m/Y H:i') : '-' }}</td>
                                </tr>
                                @empty
                                <tr>
