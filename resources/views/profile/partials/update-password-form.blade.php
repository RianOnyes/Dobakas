        ...
        <div class="grid grid-cols-1 gap-6">
            <div>
                <x-text-input id="update_password_current_password" name="current_password" type="password"
                    label="Password Saat Ini" placeholder="Masukkan password saat ini"
                    autocomplete="current-password" />
            </div>

            <div>
                <x-text-input id="update_password_password" name="password" type="password" label="Password Baru"
                    placeholder="Masukkan password baru (minimal 8 karakter)" autocomplete="new-password" />
            </div>

            <div>
                <x-text-input id="update_password_password_confirmation" name="password_confirmation" type="password"
                    label="Konfirmasi Password Baru" placeholder="Ulangi password baru" autocomplete="new-password" />
            </div>
        </div>
