    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Buat Donasi Baru</h3>
                    <p class="text-gray-600 dark:text-gray-400">
                        Donasi Anda akan dikirim ke pusat admin Berkah BaBe dan kemudian didistribusikan ke organisasi yang membutuhkan. 
                        Tim admin akan memverifikasi donasi Anda terlebih dahulu.
                    </p>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form action="{{ route('donatur.store-donasi') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        @csrf
                        ...
                        <div>
                            ...
                            <select id="category" 
                                ...
                                <option value="Perabot" {{ old('category') === 'Perabot' ? 'selected' : '' }}>Perabot</option>
                        ...
                        <div>
                            ...
                            <div class="space-y-3">
                                <div class="flex items-start">
                                    ...
                                    <div class="ml-3">
                                        <label for="self_deliver" class="text-sm font-medium text-gray-700 dark:text-gray-300">
                                            Antar Sendiri
                                        </label>
                                ...
                                <div class="flex items-start">
                                    <input type="radio" 
                                           ...
                                           class="mt-1 h-4 w-4 text-indigo-600 border-gray-300 focus:ring-indigo-500">
                                    <div class="ml-3">
                                        <label for="needs_pickup" class="text-sm font-medium text-gray-700 dark:text-gray-300">
                                            Perlu Dijemput
                                        </label>
                                        <p class="text-sm text-gray-500 dark:text-gray-400">
                        ...
                        <div id="location-field" class="hidden">
                            ...
                            <textarea id="location" 
                                      ...
                                      class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('location') }}</textarea>
                            @error('location')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="flex items-center justify-between pt-6 border-t border-gray-200 dark:border-gray-700">
                            <a href="{{ route('donatur.dashboard') }}" 
                               class="bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 px-6 py-2 rounded-md font-medium transition-colors">
                                Batal
                            </a>
                            <button type="submit" 
