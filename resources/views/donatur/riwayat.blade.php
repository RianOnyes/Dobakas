    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Riwayat Donasi</h3>
                    <p class="text-gray-600 dark:text-gray-400">Lihat riwayat donasi yang telah selesai atau dibatalkan.</p>
                </div>
            </div>
            ...
            @else
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-12 text-center">
                        ...
                        <h3 class="mt-4 text-lg font-medium text-gray-900 dark:text-gray-100">Belum ada riwayat donasi</h3>
